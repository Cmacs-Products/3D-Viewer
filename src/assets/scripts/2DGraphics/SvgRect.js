...
var SvgRect = (function () {
    ...
    function SvgRect(svgController, annotationId, type, pageNumber, element, rotation, dbobject, angle, maskids, handleids, controlboxids) {
    ...
    SvgRect.prototype = {
        ...
        onElementDragEnd: function (e) {
            if (!this.isDrawing && SvgGlobalControllerLogic.isDraggingElement) {
                ...
                that.update();console.log("DragEnd", that);
                that.createMask();
            }
        ...
        paste: function (e, pageNumber) {
            ...
            var clonedSvgObject = new SvgRect(
